...
do
    ...
    local function create_sapient_protobuf_dissector(name, desc, msgtype)
        local proto = Proto(name, desc .. " v2")
        ...
        proto.dissector = function(tvb, pinfo, tree)
            ...
            if sapient_state.is_partial_message then
                ...
                if  not success then
                    ...
                    pinfo.private["decoded_successfully"] = false
				else
                    -- Set the flag indicating successful decoding
                    pinfo.private["decoded_successfully"] = true
                end
    ...
    create_sapient_protobuf_dissector("SapientMessages_v2", "SapientMessage Sapient", "sapient_msg.bsi_flex_335_v2_0.SapientMessage")
